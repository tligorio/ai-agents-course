...
**No local setup required** - everything runs in your browser via Colab. 
1. Click any "Open in Colab" badge above
2. The tutorial will open in Google Colab
3. Follow the instructions in the notebook

**Alternatively**, clone any individual agent tutorial repository to run locally.
